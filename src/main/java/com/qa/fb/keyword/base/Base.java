...
public class Base {
	...
	public Properties init_properties() {
		...
		try {
			FileInputStream inputStream = new FileInputStream("C:\\Users\\PC\\eclipse-workspace\\KeyWordDrivenFramework\\src\\main\\java\\com\\qa\\fb\\keyword\\config\\config.properties");
